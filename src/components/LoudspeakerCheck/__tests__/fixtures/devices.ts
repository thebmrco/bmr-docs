...
export interface DeviceSheet {
  ...
  power_w: number | null
  /** Published sensitivity, dB at 1 W / 1 m, where there is one. */
...
export const DEVICES: DeviceSheet[] = [
  ...
  { id: 'marshall-emberton-iii', name: 'Marshall Emberton III', category: 'portable', spl_db: 90, spl_ref_m: 1, freq_low_hz: 65, freq_high_hz: 20000, power_w: null, sensitivity_db: null, woofer_mm: null, note: 'amplifier printed as "2X38 W", not used', source: 'https://www.marshall.com/us/en/product/emberton-iii?pid=1006884' },
  ...
  { id: 'logitech-rally-bar', name: 'Logitech Rally Bar', category: 'room-system', spl_db: 99, spl_ref_m: 0.5, freq_low_hz: null, freq_high_hz: null, power_w: null, sensitivity_db: null, woofer_mm: 70, note: '"99dB SPL @8.0W … at ½ meter"; no speaker frequency range', source: 'https://hub.sync.logitech.com/Rally-Bar/post/rally-bar---specifications-y6v2UoNh2YbpNKh' },
  { id: 'logitech-rally-bar-mini', name: 'Logitech Rally Bar Mini', category: 'room-system', spl_db: 99, spl_ref_m: 0.5, freq_low_hz: null, freq_high_hz: null, power_w: null, sensitivity_db: null, woofer_mm: 70, note: '99 dB @ 8 W at ½ m; sensitivity published twice, contradicting (90 and 86 dB)', source: 'https://hub.sync.logitech.com/rallybarmini/post/specifications---rally-bar-mini-K3ptSACa3kgpz8h' },
