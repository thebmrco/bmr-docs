...
<summary className="bmr-summary">Handle Non-LiDAR Devices Gracefully for Scanning and AR Placement </summary>
...
<details className="bmr-details">
<summary className="bmr-summary">Room Details Page Update with Task Status </summary>
