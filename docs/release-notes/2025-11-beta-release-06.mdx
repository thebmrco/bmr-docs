...
## <Icon name="smartphone" size="1em" /> iOS & AR Improvements
...
BMR Mobile now detects when the device does not support LiDAR and prevents crashes by showing a clear user message.
...
To support balloon-pop or manual impulse responses, BMR Mobile now records fully raw audio without Apple's processing.
...
## <Icon name="monitor" size="1em" /> Web Enhancements
...
## <Icon name="palette" size="1em" /> UI & Visual Fixes
