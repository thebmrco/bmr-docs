---
title: Release 5 (BETA) 2025 November
---

import Icon from '@site/src/components/Icon'

# Release 5 (BETA) 2025 November

This release introduces new functionality and usability improvements across both **BMR Mobile** and the **Web Platform**.
...
## <Icon name="puzzle" size="1em" /> Additional Notes
