...
Together, these two measurements capture something important: **a room can feel exhausting to communicate in even when speech is technically intelligible**. The MOS score reflects this perceptual reality, not just a technical threshold.
